...
const drinks = JSON.parse(
	"[" +
		...
		'{ "type":"drink", "name":"SPARKLING WATER", "description":"300ml", "price":"4.50" },' +
		'{ "type":"drink", "name":"STILL WATER", "description":"300ml", "price":"4.50" },' +
		'{ "type":"drink", "name":"SODA", "description":"300ml", "price":"5.50" },' +
		'{ "type":"drink", "name":"TAP WATER", "description":"", "price":"FREE" },' +
		'{ "type":"separator", "description":"TEE" },' +
		'{ "type":"drink", "name":"GREEN TEE", "description":"350ml", "price":"4.80" },' +
		'{ "type":"drink", "name":"BABLE GOLD", "description":"350ml", "price":"7.00" },' +
		'{ "type":"drink", "name":"ICE TEE", "description":"350ml", "price":"7.50" },' +
		'{ "type":"drink", "name":"FUSION TEE", "description":"350ml", "price":"6.00" },' +
		'{ "type":"separator", "description":"LEMONADE" },' +
		'{ "type":"drink", "name":"KLUBNICA", "description":"300ml", "price":"7.00" },' +
		'{ "type":"drink", "name":"LEMON", "description":"300ml", "price":"8.50" },' +
		'{ "type":"drink", "name":"YABLOKO", "description":"300ml", "price":"7.50" },' +
		'{ "type":"drink", "name":"CARDAMON", "description":"300ml", "price":"8.00" },' +
